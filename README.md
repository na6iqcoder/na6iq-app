...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/na6iq-app)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/na6iq-app
```

A live public deployment of this template is available at [https://na6iq-app.templates.workers.dev](https://na6iq-app.templates.workers.dev)
